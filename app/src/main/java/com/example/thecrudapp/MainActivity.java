package com.example.thecrudapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editData = findViewById(R.id.edt_hint);
    ...
    public void onAddClicked(View view) {
        ...
        if (editData.getText().toString().length() > 0) {
            ...
            data.put("task_name", editData.getText().toString());
            ...
            editData.setError("Value Required");
        }
    }
        ...
        documentReference.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    editData.setText(task.getResult().get("data").toString());
                }
            }
        });
    }
    ...
    public void onUpdateClicked(View view) {
        ...
        if (editData.getText().toString().length() > 0) {
            Map<String, Object> data = new HashMap<>();
            data.put("data", editData.getText().toString());
